...
ADMINS = [int(x) for x in os.environ.get("ADMINS", "5898522531").split(",") if x]  # multiple admins allowed ("8475661555","8475661555")

# Force Subscribe Settings
# Updated to -1002497059972 as per user request
FORCE_SUB_CHANNELS = [int(x) for x in os.environ.get("FORCE_SUB_CHANNELS", "-1003062629837").split(",") if x] # multiple force sub allowed ("-1003511440278","-1003511440278")
